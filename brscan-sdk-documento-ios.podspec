Pod::Spec.new do |s|  
    ...
    s.homepage          = 'https://github.com/CelsoJunioDev/brscan-sdk-documento-ios'

    s.author            = { 'Celso Junio Silva Santos' => 'celsoj18@gmail.com'}
    s.license           = 'MIT'

    s.platform          = :ios
    s.source            = { :git => 'https://github.com/CelsoJunioDev/brscan-sdk-documento-ios.git', :tag => s.version.to_s }
